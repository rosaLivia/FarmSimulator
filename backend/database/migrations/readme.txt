...
2)./vendor/bin/sail artisan migrate --path=/database/migrations/2024_08_05_200132_create_deliveries_table.php
3)./vendor/bin/sail artisan migrate --path=/database/migrations/2024_08_05_200100_create_orders_table.php
4)./vendor/bin/sail artisan migrate --path=/database/migrations/2024_08_05_200142_create_cart_table.php
